    ...
    void Update()
    {
        if (Input.GetMouseButtonDown(0))
        {
            ...
            if (_ResetButton.Equals(gameObject))
            {
                ...
                //  _LightButton[0].gameObject.SetActive(true);
                //  _LightButton[1].gameObject.SetActive(true);
                //  _LightButton[2].gameObject.SetActive(true);
                //  _LightButton[3].gameObject.SetActive(true);
                //  _LightButton[4].gameObject.SetActive(true);
                //   _LightButton[5].gameObject.SetActive(true);
            }
        }
    }
}
